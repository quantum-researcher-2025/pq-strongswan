 ...
 */
    ...
    // Include the necessary header for the plugin interface
    #include <plugins/plugin.h>
    // Define a type for the socket dynamic plugin structure
    ...
    struct socket_dynamic_plugin_t {
         ...
         */
        plugin_t plugin;  // The plugin interface implementation
    };
