...
ENUM_NEXT(notify_type_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_RESPONSE",
	"RADIUS_ATTRIBUTE");
ENUM_NEXT(notify_type_names, RELIABLE_IKE_TRANSPORT, RELIABLE_IKE_TRANSPORT, RADIUS_ATTRIBUTE,
    "RELIABLE_IKE_TRANSPORT");
ENUM_END(notify_type_names, RELIABLE_IKE_TRANSPORT);
...
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_R",
	"RADIUS");
ENUM_NEXT(notify_type_short_names, RELIABLE_IKE_TRANSPORT, RELIABLE_IKE_TRANSPORT, RADIUS_ATTRIBUTE,
    "RELIABLE_IKE_TRANSPORT");
ENUM_END(notify_type_short_names, RELIABLE_IKE_TRANSPORT);
