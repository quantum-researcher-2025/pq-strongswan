 ...
 */
#ifndef RECEIVER_H_
	#define RECEIVER_H_
	// Define a type for the receiver structure
	typedef struct receiver_t receiver_t;
	#include <library.h>  // Include the library header
	#include <networking/host.h>  // Include the networking host header
	#include <networking/packet.h>  // Include the networking packet header
	/**
	 ...
	 */
	typedef void (*receiver_esp_cb_t)(void *data, packet_t *packet);  // Define a type for the ESP callback function
	/**
	...
	struct receiver_t {
		 ...
		 */
		void (*add_esp_cb)(receiver_t *this, receiver_esp_cb_t callback, void *data);  // Method to add a callback for ESP packets
		/**
		 * Unregister a previously registered callback for ESP packets.
		 *
		 * @param callback		previously registered callback
		 */
		void (*del_esp_cb)(receiver_t *this, receiver_esp_cb_t callback);  // Method to delete a previously registered callback
		/**
		 * Destroys a receiver_t object.
		 */
		void (*destroy)(receiver_t *this);  // Method to destroy the receiver object
	};
	/**
